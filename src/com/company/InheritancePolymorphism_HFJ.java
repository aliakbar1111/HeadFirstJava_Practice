...
public class InheritancePolymorphism_HFJ {
    ...
    public static void main(String[] args) {
         ...
         * squirrel extended Cat , Cat extended Doggy , Doggy extended Animal
         * */
...
class ObjectInfo {
    ...
    void experiment() {
        ...
        /*TODO we know that "get(0)" is a Doggy object ,but still we can't store it in d1 variable  which is a
            reference of Doggy type object . main reason is in an ArrayList<Object> objects come in as  Dog ,
            Fox,Cow, Cat and so on type object.
            but they go out as only type of Object.
            because of that we can't store it in a Doggy type reference.
            ...
            we also can store it in a Doggy type reference by casting Doggy object.
             <code>Doggy d1 = doggies.get(0);</code>
         */
        ...
        /*
        * will not get error in code below because (d) is going out as a Object type even though it came in as Doggy */
